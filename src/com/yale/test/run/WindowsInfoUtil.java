...
public class WindowsInfoUtil {
	...
	public static String getMemery() {  
	    ...
	    /**
	     * OperatingSystemMXBean我这里使用的是java.lang.management.OperatingSystemMXBean这个包下面的OperatingSystemMXBean类
	     * osmxb.getTotalSwapSpaceSize();和osmxb.getFreePhysicalMemorySize()使用的是
	     * 这个包rt.jar下面的com.sun.management.OperatingSystemMXBean
	     * 这时就会出现com.sun.management.OperatingSystemMXBean这个类找不到！
	     * 这里的工程需要用到rt.jar，当我们额外下载导入rt.jar就可以解决这个问题，但是对于jdk来说本身是具有jar包的，
	     * 原因是eclipse将这些访问受限制的API设置成了错误，导致不能import。
	     * https://blog.csdn.net/weixin_38283270/article/details/78615879
	     */
	    //long totalvirtualMemory = osmxb.getTotalSwapSpaceSize(); // 剩余的物理内存  
	    //long freePhysicalMemorySize = osmxb.getFreePhysicalMemorySize();  
	   // Double compare = (Double) (1 - freePhysicalMemorySize * 1.0 / totalvirtualMemory) * 100;  
	    Double compare = new Double(1.0);
