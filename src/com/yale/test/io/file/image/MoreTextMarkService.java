 ...
 * @author issuser
 */
public class MoreTextMarkService {
	...
	public void watermark() {
		try {
			...
			g.dispose();//释放绘图工具
			//将带水印的图片写到指定的路径里面
			OutputStream os = new FileOutputStream(new File("C:\\Users\\issuser\\Desktop\\17cfd97aea9_2c1_moreshuiyin.jpeg"));
			//第五步:创建图形编码工具类
	...
	public static void main(String[] args) {
		MoreTextMarkService tms = new MoreTextMarkService();
		tms.watermark();
		System.out.println("添加多个文字水印设置成功了");
	}
}
