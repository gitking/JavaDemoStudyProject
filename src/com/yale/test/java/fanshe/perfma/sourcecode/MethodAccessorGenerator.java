...
//package sun.reflect;
package com.yale.test.java.fanshe.perfma.sourcecode;
...
/**
 * 回到Java的一侧。MethodAccessorGenerator长啥样呢？由于代码太长，这里就不完整贴了，
 * 有兴趣的可以到OpenJDK 6的Mercurial仓库看：OpenJDK 6 build 17的MethodAccessorGenerator。
 * 它的基本工作就是在内存里生成新的专用Java类，并将其加载。就贴这么一个方法：
 * http://hg.openjdk.java.net/jdk6/jdk6/jdk/file/b202c79afde3/src/share/classes/sun/reflect/MethodAccessorGenerator.java
 * @author dell
 */
